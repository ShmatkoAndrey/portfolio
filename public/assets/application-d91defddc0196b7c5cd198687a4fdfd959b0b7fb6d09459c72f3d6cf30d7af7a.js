...
window.onload = function () {
    ...
    function setFontSize() {
        ...
        if(w > 900 ) div.style.fontSize = '9em';
        else if(w <= 900 && w > 640) div.style.fontSize = '7em';
        else if(w <= 640 && w > 480) div.style.fontSize = '5em';
        else if(w <= 480 && w > 350) div.style.fontSize = '3.5em';
        else if(w <= 350) div.style.fontSize = '3em';
    }
