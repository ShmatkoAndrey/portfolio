...
window.onload = function () {
    ...
    function setFontSize() {
        ...
        console.log(w);
        if(w < 900 && w > 500) div.style.fontSize = '5em'; //h - parseInt(h/8)+ 'px'; //изменяем размер
        else if(w <= 500 && w > 300) div.style.fontSize = '3.5em'; //h - parseInt(h/8)+ 'px'; //изменяем размер
        else if(w <= 300) div.style.fontSize = '2.5em'; //h - parseInt(h/8)+ 'px'; //изменяем размер
    }
